            ...
            <x-table class="overflow-x-auto">
                <x-slot name='head'>
                    <x-table.heading sortable wire:click="sortBy('name')"
                        :direction="$sortField === 'name' ? $sortDirection :null" class="">name </x-table.heading>
                    ...
                    <x-table.heading sortable wire:click="sortBy('sellPrice')"
                        :direction="$sortField === 'sellPrice' ? $sortDirection :null">Sell Price </x-table.heading>
                    ...
                    <x-table.heading sortable wire:click="sortBy('device_id')"
                        :direction="$sortField === 'device_id' ? $sortDirection :null">Devices </x-table.heading>
                    <x-table.heading sortable wire:click="sortBy('quantity')"
                        :direction="$sortField === 'quantity' ? $sortDirection :null">Quantity </x-table.heading>
                    <x-table.heading />
                </x-slot>
                <x-slot name='body'>
                ...
                <x-slot name='content'>
                    <div class="row">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input wire:model.defer="accessory.buyPrice" id="buyPrice" class="block mt-1 w-full"
                                type="text" :value="old('buyPrice')" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-form.select :array='$devices' target='name' model="accessory.device_id" id="device"
                                selected="Chose the Device name" />
                        </div>
